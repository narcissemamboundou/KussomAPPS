  ...
  },
  {
    ...
    children: [
     /* {
      ...
      {
        path: 'dashboards/inscript-france',
        redirectTo: '/'
      },
      {
        path: '',
        loadChildren: () => import('./pages/dashboards/inscript-france/inscript-france.module').then(m => m.InscriptFranceModule),
      },
      {
        path: 'dashboards',
        children:[
          ...
          {
            path: 'schools',
            loadChildren: () => import('./pages/dashboards/schools/schools.module').then(m => m.SchoolsModule)
          },
        ]
      },
      {
      ...
      },
      {
        ...
        children:[
          {
            path: 'mes-services',
            loadChildren:() => import('./pages/kussServices/mes-services/mes-services.module').then(m=>m.MesServicesModule)
          },
          {
            path: 'mes-documents',
            loadChildren:() => import('./pages/kussServices/mes-documents/mes-documents.module').then(m=>m.MesDocumentsModule)
          },
          {
            path: 'partenaires',
            loadChildren:() => import('./pages/kussServices/partenaires/partenaires.module').then(m=>m.PartenairesModule)
          }
